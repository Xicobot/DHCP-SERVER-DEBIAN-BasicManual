...
For this example, we'll say that the client is in the same network as the DHCP server and he wants to have a IP Address, so he'll ask for an IP Address to the server with the 
